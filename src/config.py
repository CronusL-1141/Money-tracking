...
class Config:
    ...
    # 文件设置 - 使用动态路径，支持从任意目录运行
    DEFAULT_OUTPUT_FILE = os.path.join(_PROJECT_ROOT, "data", "output", "FIFO资金追踪结果.xlsx")
    DEFAULT_INPUT_FILE = os.path.join(_PROJECT_ROOT, "data", "input", "流水.xlsx")
