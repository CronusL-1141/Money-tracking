...
> **状态**: 已归档，不再维护  
> **当前分支**: legacy-python  
> **推荐版本**: rust-backend分支 (v3.3.4)

## ⚠️ 重要提示

**此文档为历史版本，描述的是基于Python后端的旧架构。**

### 🔄 迁移信息
- **当前分支**: `legacy-python` - 保留作为历史记录
- **生产分支**: `rust-backend` - 最新的纯Rust+Tauri实现
- **状态**: 此版本已完全被rust-backend分支替代

### 📖 如需了解最新架构
请切换到 `rust-backend` 分支查看最新的项目文档。
